...
/// <summary>
/// Страница списка задач (GET /tasks). NextCursor = null — больше страниц нет.
/// Счётчики считаются по всему отбору, но без фильтра статуса: иначе кнопки фильтра показывали бы
