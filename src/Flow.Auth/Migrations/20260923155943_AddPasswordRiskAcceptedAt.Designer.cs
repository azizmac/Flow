...
namespace Flow.Auth.Migrations
{
    ...
    [Migration("20260923155943_AddPasswordRiskAcceptedAt")]
    partial class AddPasswordRiskAcceptedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flow.Auth.Data.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("PasswordRiskAcceptedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Flow.Auth.Data.ApplicationUser", null)
                        .WithMany()
