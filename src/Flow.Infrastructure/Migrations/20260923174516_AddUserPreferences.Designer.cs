...
namespace Flow.Infrastructure.Migrations
{
    ...
    [Migration("20260923174516_AddUserPreferences")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flow.Domain.Entities.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Flow.Domain.Entities.User", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Preferences", "Flow.Domain.Entities.User.Preferences#UserPreferences", b1 =>
                        {
                            b1.IsRequired();

                            b1.Property<int>("SidebarMode")
                                .HasColumnType("integer")
                                .HasColumnName("PrefSidebarMode");

                            b1.Property<int>("StartPage")
                                .HasColumnType("integer")
                                .HasColumnName("PrefStartPage");
            ...
            modelBuilder.Entity("Flow.Infrastructure.Search.Entities.SearchChunk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<NpgsqlTsVector>("Tsv")
                        ...
                        .HasComputedColumnSql("to_tsvector('russian', \"Content\")", true);

                    b.HasKey("Id");

                    b.HasIndex("ContentHash");

                    b.HasIndex("BoardId", "IsClosed");

                    b.HasIndex("SourceType", "SourceId");

                    b.HasIndex("SourceType", "SourceId", "ChunkIndex", "ModelVersion")
                        .IsUnique();

                    b.ToTable("SearchChunks", (string)null);
                });

            modelBuilder.Entity("Flow.Infrastructure.Search.Entities.SearchIndexRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SearchIndexQueue", (string)null);
                });
